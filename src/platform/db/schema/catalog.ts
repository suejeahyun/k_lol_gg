...
export const championCatalog = catalogSchema.table(
  ...
  (table) => [
    ...
    check(
      "champion_catalog_image_url_allowlist",
      sql`${table.imageUrl} IS NULL OR ${table.imageUrl} ~ '^https://ddragon\\.leagueoflegends\\.com/cdn/[0-9]+\\.[0-9]+\\.[0-9]+/img/champion/[A-Za-z0-9]+\\.png$'`,
    ),
