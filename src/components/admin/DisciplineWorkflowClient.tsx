...
type ReviewRequest = { kind: "submission" | "task" | "ban"; id: number; action: "APPROVE" | "REJECT"; title: string; description: string; required: boolean };
