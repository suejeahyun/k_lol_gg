...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    title: "통합 도움말",
    room: "전체 사용 가능",
    description: "LOL-K 기능, 구인구직 기능, 내전 구인 기능을 한 번에 확인합니다.",
  ...
  },
  {
    ...
    title: "모집번호 초기화",
    room: "K롤방 구인구직방",
    description: "다음 구인 생성 번호를 #1부터 다시 시작합니다.",
    commands: ["모집번호초기화", "구인번호초기화", "구인초기화", "파티번호초기화", "recruit-reset"],
    status: "초기화 완료",
    tone: "reset",
    messages: [
      { side: "me", name: "관리자", text: "모집번호초기화", time: "오후 8:28" },
      {
        side: "bot",
        name: "K-LOL 구인구직 도우미",
        text: "[K-LOL.GG 구인구직 모집번호 초기화 완료]\n다음 구인 생성부터 모집번호 #1부터 다시 사용됩니다.",
        time: "오후 8:28",
        status: "초기화 완료",
      },
    ],
