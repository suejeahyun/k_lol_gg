...
const scenarios: Scenario[] = [
  {
    ...
    room: "전체 사용 가능",
    description:
      "현재 사용 중인 카카오톡 명령어 전체 설명 페이지를 확인합니다.",
  ...
  },
  {
    ...
    room: "LOL - K / 전체 사용 가능",
    description:
      "LOL-K 기본 명령어만 확인합니다. 구인구직은 구인도움말로 분리했습니다.",
...

  {
    ...
    room: "구인구직방 / 전체 사용 가능",
    description:
      "구인구직 파티 생성, 현황, 마감, 내전구인 명령어만 따로 확인합니다.",
  ...
  },
  {
    ...
    room: "K롤방 구인구직방",
    description:
      "참가 신청 양식을 작성해 보내면 사이트 신청 현황에 저장합니다.",
  ...
  },
  {
    ...
    commands: ["2인파티", "6인파티", "10인구인", "숫자+인파티"],
    status: "구인 생성 완료",
    tone: "create",
    messages: [
      { side: "me", name: "사용자", text: "6인파티", time: "오후 8:16" },
      {
        side: "bot",
        name: "K-LOL 구인구직 도우미",
  ...
  },
  {
    ...
    room: "K롤방 구인구직방",
    description:
      "모집번호가 포함된 구인 양식을 수정해 다시 보내면 구인현황에 저장합니다.",
  ...
  },
  {
    ...
    commands: ["12ㅉ", "13ㅉ", "#12ㅉ"],
    status: "마감 완료",
    tone: "reset",
    messages: [
      { side: "me", name: "사용자", text: "12ㅉ", time: "오후 8:26" },
      {
        side: "bot",
        name: "K-LOL 구인구직 도우미",
  ...
  },
  {
    ...
    room: "K롤방 구인구직방",
    description:
      "같은 신청글 또는 같은 구인 양식을 다시 처리할 수 있게 중복 인식값을 초기화합니다.",
    commands: ["신청초기화"],
    status: "초기화 완료",
    tone: "reset",
    messages: [
  ...
  },
  {
    ...
    room: "K롤방 구인구직방",
    description:
      "모집번호가 없는 구인 양식은 기존 구인과 연결할 수 없어 처리하지 않습니다.",
  ...
  return (
    <main className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroPanel}>
          ...
          <p className={styles.heroText}>
            롤방에서 입력하는 명령어와 봇이 반환하는 출력값을 카카오톡 대화
            화면처럼 정리했습니다. 구인 생성, 저장 완료, 현황 조회, 초기화,
            무응답 처리까지 한 페이지에서 확인할 수 있습니다.
          </p>
      ...
      <section className={styles.ruleCard}>
        <strong>핵심 규칙</strong>
        <p>
          구인 참여·수정·삭제는 모집번호가 기준입니다. 기존 구인 양식을 다시
          보낼 때는 반드시 <b>모집번호: #번호</b>를 유지해야 합니다. 모집번호가
          없는 양식은 기존 글과 연결할 수 없어 봇이 답장하지 않도록 처리됩니다.
        </p>
      </section>
