  ...
  if (loading) {
    return (
      <div className="page-container">
        ...
        <div className="admin-dashboard-loading">데이터를 불러오는 중입니다.</div>
      </div>
    );
  }
    ...
    <div className="page-container">
      ...
      <section className="admin-summary-grid">
        ...
        <div className="admin-summary-card">
          ...
          <div className="admin-summary-card__meta">등록된 전체 플레이어</div>
        </div>
        ...
        <div className="admin-summary-card">
          ...
          <div className="admin-summary-card__meta">등록된 전체 내전</div>
        </div>
      ...
      <section className="admin-log-section">
        <div className="admin-log-section__header">
          ...
          <div className="admin-log-count">
            총 {data.logs.length.toLocaleString()}개
          </div>
        </div>
            ...
            {data.logs.map((log) => (
              <div key={log.id} className="admin-log-item">
                <div className="admin-log-item__left">
                  <span className="admin-log-item__type">{log.type}</span>
