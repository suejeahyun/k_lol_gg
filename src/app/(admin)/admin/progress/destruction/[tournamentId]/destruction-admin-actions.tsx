...
export function DestructionAdminActions({ destruction, playerOptions, playerLabels, galleryOptions, view = "default" }: Readonly<{
  ...
  if (view === "auction-live") return <section className={styles.actions} aria-labelledby="auction-live-actions-title"><h2 id="auction-live-actions-title">실시간 경매 작업</h2><p aria-live="polite">8초마다 최신 경매 상태를 확인합니다.</p><div className={styles.actionsGrid}>
