...
export default async function AdminDestructionDetailPage({ params, searchParams }: { params: Promise<{ tournamentId: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main className={styles.page}>
    ...
    <DestructionAdminActions destruction={destruction} playerOptions={playerOptions} playerLabels={playerLabels} galleryOptions={galleryOptions} view={view} superAdmin={session.role === "SUPER_ADMIN"} />
