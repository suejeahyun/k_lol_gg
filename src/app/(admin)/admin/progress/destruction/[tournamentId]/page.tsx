...
export default async function AdminDestructionDetailPage({ params }: { params: Promise<{ tournamentId: string }> }) {
  ...
  let destruction;
  try { destruction = await runtime.repository.getAdmin(tournamentId); }
  ...
  return <main className={styles.page}>
    ...
    <DestructionAdminActions destruction={destruction} />
  </main>;
}
