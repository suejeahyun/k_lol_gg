      ...
      <div className="admin-page__header">
        <div>
          ...
          <p className="admin-page__description">
            생성 즉시 모집중으로 시작합니다. 참가자와 팀 구성은 상세 페이지에서 진행합니다.
          </p>
        </div>
      </div>
      ...
      <div className="admin-form">
        ...
        <div className="admin-event-form-grid">
          <div className="admin-form__group">
            ...
            >
              <option value="POSITION">포지션 지정 · 점수 시드</option>
              <option value="ARAM">포지션 없음 · 랜덤 시드</option>
            </select>
          </div>
        ...
        <div className="empty-box">
          진행 상태는 자동으로 모집중으로 저장됩니다. 모집 시작일, 모집 종료일, 설명은 사용하지 않습니다.
        </div>
