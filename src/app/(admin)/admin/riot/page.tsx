    ...
    <main className={styles.page}>
      <div className={styles.header}>
        ...
        <div className={styles.actions}>
          ...
          {isSuperAdmin ? <Link className={styles.secondaryButton} href="/admin/riot/accounts/bulk-link">일괄 연결</Link> : null}
      ...
      <section className={styles.quickGrid}>
        ...
        {isSuperAdmin ? <Link className={styles.quickCard} href="/admin/riot/accounts/bulk-link"><strong>일괄 연결</strong><span>미연동 플레이어를 닉네임#태그 기준으로 30명 단위 연결합니다.</span></Link> : null}
