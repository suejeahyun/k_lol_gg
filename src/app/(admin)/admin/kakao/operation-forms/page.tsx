...
const cards = [
  {
    ...
    title: "디스코드 초대",
    description: "지인 정보, 이용 기간, 디스코드 닉네임 변경 내용을 확인합니다.",
  },
  {
    key: "leaves",
    href: "/admin/kakao/operation-forms/leaves",
    title: "외출 신청",
    description: "외출 기간, 사유, 범위를 확인하고 관리자 메모를 보관합니다.",
  },
  {
    key: "meetups",
    href: "/admin/kakao/operation-forms/meetups",
    title: "오프라인 모임",
    description: "오프라인 모임 신청 내용을 확인하고 기록용으로 관리합니다.",
  },
  {
    key: "suggestions",
    href: "/admin/kakao/operation-forms/suggestions",
    title: "건의",
...
export default async function AdminOperationFormsPage() {
  const [friends, leaves, meetups, suggestions] = await Promise.all([
        ...
        <div className="admin-page__header" style={{ marginBottom: 28 }}>
          <div>
            ...
            <p className="admin-muted" style={{ marginTop: 8 }}>
              디스코드 초대, 외출신청, 오프라인모임, 건의는 정보 확인 및 보관용으로 관리합니다.
