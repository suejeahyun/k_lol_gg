...
export async function POST(request: Request) {
  ...
  try { return operationsMutationResponse(await repository.runAdminCleanup({ actor: operationsActor(authorization.session), metadata: prepared.metadata, kind: "audit", retentionDays: body.retentionDays }), prepared.traceId); }
