...
import { FEATURES_KAKAO_ROOM_COMMAND, MAXIMUM_KAKAO_IMAGE_BODY_BYTES } from "@/modules/recruiting/infrastructure/kakao-http-request";
...
export async function POST(request: Request) {
  const prepared = await prepareKakaoSignedJson(request, MAXIMUM_KAKAO_IMAGE_BODY_BYTES, FEATURES_KAKAO_ROOM_COMMAND);
