...
async function redirect(context: { params: Promise<{ draftId: string }> }) { return legacyRedirectResponse(buildLegacyCanonicalIdDestination("/tools/team-balance/drafts", (await context.params).draftId, "/tools/team-balance/drafts", { tab: "recommendations" })); }
