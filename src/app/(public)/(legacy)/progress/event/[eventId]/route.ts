...
async function redirect(context: { params: Promise<{ eventId: string }> }) { return legacyRedirectResponse(buildLegacyCanonicalIdDestination("/competitions/events", (await context.params).eventId, "/competitions/events")); }
