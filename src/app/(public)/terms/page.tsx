...
export default function TermsPage() {
  return <div className={styles.page}><article className={styles.policy}>
    ...
    <section><h2>1. 적용 범위</h2><p>이 문서는 현재 다시 구현 중인 K-LOL.GG V2의 계정 가입, 승인, 로그인과 운영 기능에 적용됩니다. V2 전체 기능이나 운영 배포 완료를 의미하지 않습니다.</p></section>
    ...
    <section><h2>6. 중단과 변경</h2><p>V2는 단계적으로 구축 중이며 점검이나 장애로 일부 기능이 중단될 수 있습니다. 중요한 정책 변경 시 새 정책 식별자와 시행일을 표시하고 필요한 경우 다시 동의를 받습니다. 이 식별자는 사이트 V1/V2 제품 버전이 아닙니다.</p></section>
