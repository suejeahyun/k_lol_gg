...
export default async function AccountPasswordPage() {
  ...
  return <div className={styles.page}><div className={styles.accessGrid}>
    <section className={styles.intro}><span className={styles.eyebrow}><KeyRound aria-hidden="true" /> PASSWORD SECURITY</span><h1>새 비밀번호로<br />안전하게 바꿔요.</h1><p>계정 상태와 관계없이 비밀번호를 변경할 수 있습니다. 변경 후에는 모든 기기에서 다시 로그인해야 합니다.</p></section>
