...
export function DestructionOwnerActions({ tournamentId, revision, status, signedIn, approved, application, mvpBallots, focusTarget = null, available = true, gameMode = "CLASSIC" }: Readonly<{
  ...
  function submitApplication(event: FormEvent<HTMLFormElement>) {
    ...
    void mutate(`/api/competitions/destruction/${tournamentId}/application`, "PUT", { applicationId: application?.applicationId ?? crypto.randomUUID(), position: data.get("position"), captainVolunteer: data.get("captainVolunteer") === "true" });
  }
