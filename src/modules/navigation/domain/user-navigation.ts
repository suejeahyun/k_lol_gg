...
export const canonicalUserRoutes = [
  ...
  { template: "/account", label: "내 계정", section: "home-account", implementationState: "planned" },
  { template: "/account/password", label: "비밀번호 변경", section: "home-account", implementationState: "planned" },
  ...
  { template: "/login", label: "로그인", section: "auth-help", implementationState: "planned" },
  { template: "/signup", label: "회원가입", section: "auth-help", implementationState: "planned" },
  { template: "/forgot-password", label: "비밀번호 찾기", section: "auth-help", implementationState: "planned" },
  { template: "/terms", label: "이용약관", section: "auth-help", implementationState: "planned" },
  { template: "/privacy", label: "개인정보 처리방침", section: "auth-help", implementationState: "planned" },
  ...
  { template: "/applications", label: "참가 신청", section: "competitions", implementationState: "planned" },
