...
const commands = [
  ...
  { id: "recruits", label: "구인 현황", description: "현재 파티 모집과 기존 모집 기록", href: "/recruits", group: "콘텐츠", access: "PUBLIC", keywords: ["파티", "스크림", "카카오", "모집", "기록"] },
  ...
  { id: "help-kakao", label: "카카오 도움말", description: "명단 복사·이름 추가로 파티와 내전 참가", href: "/help/kakao", group: "페이지", access: "PUBLIC", keywords: ["카카오", "봇", "명령", "복사", "붙여넣기", "참가", "처음"] },
  { id: "help-recruits", label: "구인 도움말", description: "참가하기와 새 모집 만들기", href: "/help/recruits", group: "페이지", access: "PUBLIC", keywords: ["파티", "내전", "모집", "복사", "이름", "저장", "참가"] },
