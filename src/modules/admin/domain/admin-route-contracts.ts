...
export const ADMIN_ROUTE_CONTRACTS = [
  ...
  { id: "008", source: "/admin/logs/kakao", decision: "redirect", target: "/admin/kakao?tab=logs", access: "SUPER" },
  ...
  { id: "045", source: "/admin/kakao/recruits", decision: "integrate", target: "/admin/kakao?tab=recruits", access: "MIXED" },
  { id: "046", source: "/admin/kakao/recruits/logs", decision: "integrate", target: "/admin/kakao?tab=logs", access: "SUPER" },
  { id: "047", source: "/admin/kakao/recruits/settings", decision: "integrate", target: "/admin/kakao?tab=health", access: "SUPER" },
  ...
  { id: "050", source: "/admin/kakao/settings", decision: "integrate", target: "/admin/kakao?tab=settings", access: "SUPER" },
  ...
  { id: "063", source: "/admin/recruits", decision: "retire", target: "/admin/kakao?tab=recruits", access: "ADMIN" },
