# MessengerBot R V1 strict R22 설치 안내
...
`integrations/messengerbot-r/v1-strict/KLOL_KAKAO_BOT_V1_STRICT_MESSENGERBOT_R.js`는 비밀값이 없는 공개 검토·생성 기준 파일이다. 휴대폰 설치에는 이 공개 파일이나 과거 설치본을 사용하지 말고, 위 `.private` R22 파일만 사용한다.
...
5. 파일 안에서 `KLOL_KAKAO_BOT_V40_R22_2026_09_18`을 검색한다.
...
| --- | --- | ---: | ---: | ---: | --- |
| 공개 검토·생성 기준, 설치 금지 | `integrations/messengerbot-r/v1-strict/KLOL_KAKAO_BOT_V1_STRICT_MESSENGERBOT_R.js` | 63,720 | 65,528 | 1,809 | `283c758142df12ba015cd6eed2ba33f08310997834a2364888ed76f3919d3465` |
| 휴대폰 한 번 붙여넣기 | `.private/KLOL_KAKAO_BOT_V1_STRICT_PRIVATE_MESSENGERBOT_R.js` | 62,009 | 63,818 | 1,810 | `7725ab9aa7ce9d8f97b0e1e0120c895e3743d3bdfa154ce6911fc2833cffe90d` |
