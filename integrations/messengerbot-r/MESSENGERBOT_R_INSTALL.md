# MessengerBot R V1 strict R21 설치 안내
...
`integrations/messengerbot-r/v1-strict/KLOL_KAKAO_BOT_V1_STRICT_MESSENGERBOT_R.js`는 비밀값이 없는 공개 검토·생성 기준 파일이다. 휴대폰 설치에는 이 공개 파일이나 과거 설치본을 사용하지 말고, 위 `.private` R21 파일만 사용한다.
...
5. 파일 안에서 `KLOL_KAKAO_BOT_V40_R21_2026_09_17`을 검색한다.
