...
async function runContractTests(connectionString: string): Promise<void> {
  ...
  const scopedTestFiles: Readonly<Record<string, readonly string[]>> = {
    ...
    recruiting: ["tests/database/recruiting.contract.test.ts", "tests/database/operation-forms.contract.test.ts", "tests/database/kakao-assistant.contract.test.ts", "tests/database/kakao-form-snapshots.contract.test.ts", "tests/database/kakao-room-registry.contract.test.ts", "tests/kakao-v4-input-tolerance-p0.test.ts"],
