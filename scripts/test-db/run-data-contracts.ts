...
async function runContractTests(connectionString: string): Promise<void> {
  ...
  const allTestFiles = [
    ...
    "tests/database/kakao-form-snapshots.contract.test.ts",
    "tests/database/kakao-room-registry.contract.test.ts",
    "tests/database/kakao-party-overview.contract.test.ts",
    ...
    "tests/database/storage-probe.contract.test.ts",
    "tests/database/operational-health.contract.test.ts",
  ...
  const scopedTestFiles: Readonly<Record<string, readonly string[]>> = {
    ...
    operations: ["tests/database/operations.contract.test.ts", "tests/database/storage-probe.contract.test.ts", "tests/database/operational-health.contract.test.ts"],
