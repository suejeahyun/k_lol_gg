...
test("the V1 strict phone installer uses the private R14 artifact and omits public-only provenance", async () => {
  ...
  assert.match(installGuide, /KLOL_KAKAO_BOT_V40_SITE_FIRST_NO_CODES_R14_2026_09_14_RHINO_CLEAN/u);
