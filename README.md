...
최근 서버 패치는 **랭킹 갱신 1.0.0**, source `39677494`입니다. MMR 자동 갱신 예약과 일반 랭킹 전체 참가자 보기·집계 시각을 추가했습니다. 기존 MMR 공식 전환은 최고 관리자 확인 대기이며 아직 점수를 재계산하지 않았습니다. [검증·배포 근거](docs/qa-evidence/ranking-refresh-v1.0.0-2026-09-25/README.md)를 확인하세요. 본인 이름 변경과 카카오 저장 후 전체 현황 기능은 유지됩니다.
