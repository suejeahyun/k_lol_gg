...
**멸망전 1.1.1 운영 반영**: 참가 심사 중 선택한 선수 행만 잠그고 다른 선수를 연속 심사할 수 있습니다. 순차 저장·중복 클릭 방지·응답 유실 복구·동시 운영자 충돌 보호를 확인했습니다. 기존 모드별 모집 규칙과 단계 조회·경매 연출을 유지합니다. [운영 검증과 변경 내용](docs/qa-evidence/destruction-modes-v1.1.1-2026-09-25/README.md).
