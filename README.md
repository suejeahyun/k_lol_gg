...
최근 서버 패치는 **운영·감사 신청 메뉴 1.0.0**, source `a669aaff`입니다. 모임·외출·건의사항·디스코드 초대를 운영·감사에서 바로 열며 기존 신청 113건을 유지합니다. [검증·배포 근거](docs/qa-evidence/operations-forms-menu-v1.0.0-2026-09-25/README.md)를 확인하세요. 앞선 랭킹 갱신 예약·전체 참가자 보기, 본인 이름 변경, 카카오 저장 후 전체 현황 기능은 유지됩니다. 기존 MMR 공식 전환은 최고 관리자 확인 대기이며 아직 점수를 재계산하지 않았습니다.
