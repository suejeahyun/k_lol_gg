...
**멸망전 1.1.2 운영 반영**: 참가 확정 저장 후 배포 중계 서버가 성공 응답을 오류로 바꿔 심사가 잠기던 원인을 수정했습니다. 전용 revision 헤더로 동시 수정·중복 저장 보호를 유지하며 다른 선수를 연속 심사할 수 있습니다. 운영 응답 조건을 재현해 74화면·18상호작용을 검증했습니다. [원인·검증·배포 근거](docs/qa-evidence/destruction-modes-v1.1.2-2026-09-25/README.md).
