...
2026-09-22 복사 양식 안정화 패치는 번호형 파티의 안전한 편집, 구형 내전 양식 호환, 마감 안내와 R25 도움말을 보완했습니다. **운영 미배포·휴대폰 미설치**이며 [검증·산출물·남은 확인](docs/qa-evidence/kakao-copy-reliability-v1.0.0-2026-09-22/README.md)에서 확인할 수 있습니다. 이전 내전 패치의 `0041` migration을 포함한 서버 적용이 필요합니다.
