...
**멸망전 3개 모드 1.0.0 운영 반영**: 협곡·칼바람·증바람 생성, 모드별 임시 등급/경매 포인트, 공통 카드·효과음과 대회 종료까지의 운영 흐름을 적용했습니다. 증바람 전적은 운영자 확인 입력입니다. [운영 검증과 사용 순서](docs/qa-evidence/destruction-modes-2026-09-25/README.md).
